...
echo "========================================="
CUDA_VISIBLE_DEVICES=$GPU_ID python src/huggingface_accumulation.py model=bert
...
echo "========================================="
CUDA_VISIBLE_DEVICES=$GPU_ID python src/huggingface_accumulation.py model=modernbert
